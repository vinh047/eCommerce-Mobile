...
-- CreateEnum
CREATE TYPE "ControlType" AS ENUM ('select', 'multiselect', 'bucket_select');

-- CreateEnum
CREATE TYPE "DataType" AS ENUM ('string', 'number', 'boolean', 'array', 'bucket', 'json');

-- CreateEnum
CREATE TYPE "FacetType" AS ENUM ('discrete', 'range');
...
CREATE TABLE "option_specs" (
    ...
    "variant_spec_id" INTEGER,

    CONSTRAINT "option_specs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "product_specs_facet_id_idx" ON "product_specs"("facet_id");

-- CreateIndex
CREATE INDEX "product_specs_spec_template_id_idx" ON "product_specs"("spec_template_id");

-- CreateIndex
CREATE INDEX "variant_specs_facet_id_idx" ON "variant_specs"("facet_id");

-- CreateIndex
CREATE INDEX "variant_specs_spec_template_id_idx" ON "variant_specs"("spec_template_id");

-- CreateIndex
CREATE INDEX "option_specs_product_spec_id_idx" ON "option_specs"("product_spec_id");

-- CreateIndex
CREATE INDEX "option_specs_variant_spec_id_idx" ON "option_specs"("variant_spec_id");

-- CreateIndex
CREATE INDEX "buckets_facet_id_idx" ON "buckets"("facet_id");
...
-- AddForeignKey
ALTER TABLE "product_specs" ADD CONSTRAINT "product_specs_facet_id_fkey" FOREIGN KEY ("facet_id") REFERENCES "facets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "variant_specs" ADD CONSTRAINT "variant_specs_facet_id_fkey" FOREIGN KEY ("facet_id") REFERENCES "facets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "option_specs" ADD CONSTRAINT "option_specs_product_spec_id_fkey" FOREIGN KEY ("product_spec_id") REFERENCES "product_specs"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "option_specs" ADD CONSTRAINT "option_specs_variant_spec_id_fkey" FOREIGN KEY ("variant_spec_id") REFERENCES "variant_specs"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "buckets" ADD CONSTRAINT "buckets_facet_id_fkey" FOREIGN KEY ("facet_id") REFERENCES "facets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
