  ...
  return (
    <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
      <tr>
        ...
        {columnVisibility.code && <ThSortable field="code" label="Mã Đơn" />}
        {columnVisibility.user && <ThSortable field="userId" label="Khách hàng" />}
        {columnVisibility.total && <ThSortable field="total" label="Tổng tiền" />}
        {columnVisibility.status && <ThSortable field="status" label="Trạng thái" />}
        {columnVisibility.payment && <ThSortable field="paymentStatus" label="Thanh toán" />}
        {columnVisibility.shipping && <ThSortable field="shippingStatus" label="Vận chuyển" />}
