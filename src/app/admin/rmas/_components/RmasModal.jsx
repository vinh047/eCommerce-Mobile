  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center px-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-2xl shadow-2xl overflow-hidden">
        {/* Header */}
        ...
        <div className="flex flex-col md:flex-row min-h-[60vh] gap-2">
          {/* Left Side */}
          <div className="w-full md:w-1/2 p-6 border-r border-gray-200 dark:border-gray-700 overflow-y-auto scrollbar-thin bg-gray-100 dark:bg-gray-900/30">
            <h4 className="font-semibold text-gray-800 dark:text-white mb-3 flex items-center">
              <AlertCircle className="w-4 h-4 mr-2 text-blue-500" /> Thông tin
              yêu cầu
            </h4>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="font-medium dark:text-gray-200">
                  {rma.orderItem?.nameSnapshot}
                </p>
              </div>
              <div>
                <p className="text-gray-500">Lý do khách báo</p>
                <p className="bg-white dark:bg-gray-700 p-2 rounded border dark:border-gray-600 mt-1">
                  {rma.reason}
                </p>
              </div>
          ...
          {/* Right Side */}
          <div className="w-full md:w-1/2 p-6 overflow-y-auto scrollbar-thin">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4 flex justify-end gap-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-2 border rounded hover:bg-gray-100 dark:border-gray-600 dark:text-white dark:hover:bg-gray-700"
                >
                  Hủy
                </button>
                <button
                  type="submit"
                  className="px-6 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700 flex items-center"
                >
