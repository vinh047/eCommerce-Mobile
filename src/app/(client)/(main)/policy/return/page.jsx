      ...
      <div className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-8 rounded-r-lg">
          <p className="text-sm font-medium text-blue-800">
            Cam kết "1 Đổi 1" trong vòng 30 ngày nếu có lỗi từ nhà sản xuất đối
            với tất cả sản phẩm điện thoại, laptop, máy tính bảng.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section>
            ...
            <ul className="list-disc pl-9 space-y-2 text-gray-600 text-sm">
              <li>
                Máy không bị trầy xước, cấn móp, nứt vỡ, vào nước (Thẩm định bởi
                kỹ thuật viên).
              </li>
              <li>
                Còn đầy đủ hộp, phụ kiện đi kèm (cáp, sạc, tai nghe, sách hướng
                dẫn, cây lấy sim...).
              </li>
              <li>
                Máy còn nguyên tem bảo hành (nếu có) và quà tặng đi kèm (nếu
                có).
              </li>
              <li>
                Tài khoản cá nhân (iCloud, Samsung Account, Google...) đã được
                đăng xuất hoàn toàn.
              </li>
            </ul>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ml-8">
              <div className="p-4 border rounded-lg bg-gray-50 text-center">
                ...
                <p className="text-xs text-gray-500">
                  Mang máy ra cửa hàng gần nhất hoặc gửi chuyển phát nhanh.
                </p>
              </div>
              <div className="p-4 border rounded-lg bg-gray-50 text-center">
                <div className="font-bold text-gray-800 mb-1">Bước 2</div>
                <p className="text-xs text-gray-500">
                  Kỹ thuật viên kiểm tra tình trạng máy và định giá (nếu có).
                </p>
              </div>
              <div className="p-4 border rounded-lg bg-gray-50 text-center">
                <div className="font-bold text-gray-800 mb-1">Bước 3</div>
                <p className="text-xs text-gray-500">
                  Hoàn tiền hoặc đổi sản phẩm mới ngay lập tức.
                </p>
              </div>
            </div>
          </section>
