...
import { X, Info, DollarSign, Image, Search } from "lucide-react";
...
export default function ProductModal({ mode, product, onClose, onSave }) {
  ...
  const tabs = [
    ...
    { id: "pricing", name: "Giá & Kho", icon: DollarSign },
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* Modal */}
        <div className="relative z-10 inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit}>
            <div className="px-6 py-6 max-h-96 overflow-y-auto">
              ...
              {/* Images & SEO tabs remain the same, có thể thay icon Lucide tương tự */}
            </div>
